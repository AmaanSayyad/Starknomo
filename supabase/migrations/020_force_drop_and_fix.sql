-- We must forcefully DROP the exact signature Postgres is complaining about first, 
-- regardless of what return type it thinks it has.
...
-- 1. CREATE Standardized Deposit RPC
...
-- 2. CREATE Standardized Withdrawal RPC
