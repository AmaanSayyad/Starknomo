...
const TOUR_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        title: 'Quick Deposit',
        content: 'Easily deposit STRK to start trading. Transactions are instant and secure.',
        position: 'top'
    }
];
...
export const QuickTour: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
    ...
    const steps: TourStep[] = useMemo(() => [
        ...(isConnected ? [] : [{
            ...
            content: 'Start by connecting your wallet. We support Starknet Sepolia for a seamless trading experience.',
