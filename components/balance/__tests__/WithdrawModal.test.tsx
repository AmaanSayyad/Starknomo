...
describe('WithdrawModal', () => {
  ...
  describe('Rendering', () => {
    it('should not render when isOpen is false', () => {
      ...
      expect(screen.queryByText('Withdraw STRK')).not.toBeInTheDocument();
    });
    ...
    it('should render when isOpen is true', () => {
      ...
      expect(screen.getByText('Withdraw STRK')).toBeInTheDocument();
    });
    ...
    it('should display house balance', () => {
      ...
      expect(screen.getByText('50.0000 STRK')).toBeInTheDocument();
    });
