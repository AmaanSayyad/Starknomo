...
describe('DepositModal', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    (useStarknomoStore as unknown as jest.Mock).mockReturnValue(defaultStoreState);
  });
  ...
  describe('Rendering', () => {
    it('should not render when isOpen is false', () => {
      ...
      expect(screen.queryByText('Deposit STRK')).not.toBeInTheDocument();
    });
    ...
    it('should render when isOpen is true', () => {
      ...
      expect(screen.getByText('Deposit STRK')).toBeInTheDocument();
    });
    ...
    it('should render quick select buttons', () => {
      ...
      expect(screen.getByText('1 STRK')).toBeInTheDocument();
      expect(screen.getByText('5 STRK')).toBeInTheDocument();
      expect(screen.getByText('10 STRK')).toBeInTheDocument();
      expect(screen.getByText('25 STRK')).toBeInTheDocument();
    });
  ...
  describe('Quick Select Buttons', () => {
    it('should set amount when quick select button is clicked', () => {
      ...
      const quickButton = screen.getByText('5 STRK');
    ...
    it('should disable quick select buttons that exceed wallet balance', () => {
      (useStarknomoStore as unknown as jest.Mock).mockReturnValue({
        ...defaultStoreState,
        balance: '15.0',
      });
      ...
      const button25 = screen.getByText('25 STRK');
      expect(button25).toBeDisabled();
      
      const button10 = screen.getByText('10 STRK');
    ...
    it('should highlight selected quick amount', () => {
      ...
      const quickButton = screen.getByText('10 STRK');
      fireEvent.click(quickButton);
