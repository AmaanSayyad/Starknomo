...
export const Leaderboard: React.FC = () => {
    ...
    const STARKNET_LOGO = '/logos/starknet-token-strk-logo.svg';
    const getNetworkIcon = () => STARKNET_LOGO;

    const getCurrencySymbol = () => 'STRK';
                                        ...
                                        >
                                            <div className="flex items-center gap-2 sm:gap-3">
                                                ...
                                                <div className="w-6 sm:w-8 text-center flex-shrink-0">
                                                    <span className={`text-xs sm:text-sm font-black tabular-nums ${index < 3 ? 'text-amber-400' : 'text-gray-500'}`}>
                                                        #{index + 1}
                                                    </span>
                                                </div>
