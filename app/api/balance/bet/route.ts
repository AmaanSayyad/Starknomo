 ...
 * Note: Game logic is off-chain. No blockchain call needed.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { userAddress, betAmount, currency = 'STRK', roundId, targetPrice, isOver, multiplier, targetCell } = body;
    ...
    // Note: After Starknet migration, game logic is off-chain. No blockchain call needed.
